...
function updateTimer() {
  const targetDate = new Date("july 7, 2026 22:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '543875912597'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const recipientNumber1 = '543875912597'; // Número para el primer botón
  const recipientNumber2 = '541124090717'; // Número para el segundo botón
